...
The simulated data is too large to be pushed to GitHub. The zip file can be downloaded from (link).
The results of MoGCN analysis are also too large to be pushed to GitHub. The zip file can be downloaded from (link).
